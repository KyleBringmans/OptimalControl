function p = controller(varargin)
...
%p.covarSensors_att = diag([1e-2 1e-2 1e-2 1e-1 1e-1 1e-1]);
p.covarDynamics_att = 1e-5 * eye(3);
p.covarSensors_att = 1e1*diag([0.0069^2, 0.007^2, 0.0069^2, 0.002^2, 0.002^2, 0.002^2]);


% covarDynamics for altitude (covariances for 'v' and 'w'
% v represents measurement noise
% w represents noise introduced by an actuator
p.covarDynamics_alt = 1e-5;
